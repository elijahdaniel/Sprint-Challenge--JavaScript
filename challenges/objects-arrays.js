...
const contactInfo = [];
const firstEmail = (x) => {contactInfo.push(`${x.first_name} ${x.email}`)}

graduates.forEach(firstEmail);
...
*/
const animalNames = [];
const sciName = (x) => {animalNames.push(`Name: ${x.animal_name} Scientific: ${x.scientific_name}`)}

zooAnimals.forEach(sciName);
